  ...
  return (
    <div className="mainContainer">
      <div className="pure-g">
        ...
        <div className="pure-u-1 pure-u-lg-4-24 pure-u-md-1">
          <div className="textContainer">
            <p>
              The <a className="aText" href="http://www.healthdata.org/gbd/faq#What%20is%20a%20DALY?">disability-adjusted life year (DALY)</a> is a measure of overall disease burden. It 
            ...
            <p>
              Data can be viewed for 1997, 2007 and 2017, and for males, females or both combined. Change these
              selections with the sliders below.
            </p>
            <p>
              Clicking on a country on the map will show a plot with the 10 causes that lead to the largest number of DALYs.
            </p>
          ...
          <div className="textContainer">
            ...
            <form className="pure-form pure-form-stacked">
              <fieldset>
                ...
                <select value={disease} name="diseaseSelect" style={{width:"100%"}} onChange={(e) => setDisease(e.target.value)}>
        ...
        <div className="pure-u-1 pure-u-lg-15-24 pure-u-md-18-24">
          
          <div className="mapContainer"  style={{height:"82.5%"}}>
          <MapChart 
        ...
        <div className="pure-u-1 pure-u-lg-5-24 pure-u-md-6-24">
          <div className="textContainer" style={{textAlign:"center", height:"100px"}}>
            <p><b>Color bar</b></p>
          <ColorBar diseaseMax = { rateMax[disease]["DALYs (Disability-Adjusted Life Years)"].Rate }/>
          </div>
          <br/>
          <div className="textContainer" style={{height:"68%"}}>
